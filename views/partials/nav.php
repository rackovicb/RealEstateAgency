            ...
            <div class="flex items-center">
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/real_estates" class="<?= urlIs('/real_estates') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Real Estates</a>
                        <?php endif; ?>
                        ...
                        class="<?= urlIs('/my-properties') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium">
                            My Properties
                        </a>
                        <a href="/favorites"
                        class="<?= urlIs('/favorites') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium">
                             Favorites
                        </a>
                        <?php endif; ?>
                    </div>
